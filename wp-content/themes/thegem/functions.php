...
function thegem_setup() {
	...
	if(!get_option('pw_options')) {
		$pw_options = array(
			...
			'sidebars' => array('page-sidebar', 'page-sidebar-1', 'footer-widget-area', 'shop-sidebar'),
		);
...
function thegem_sidebar_init() {
	...
	register_sidebar(array(
		'name'          => esc_html__('Projects', 'thegem'),
		'id'            => 'projects-sidebar',
		'description'   => esc_html__('Main sidebar that appears on the left.', 'thegem'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		...
		'after_title'   => '</h4>',
			...
			register_sidebar(array(
		'name'          => esc_html__('Publications', 'thegem'),
	...
	register_sidebar(array(
		...
		register_sidebar(array(
		'name'          => esc_html__('Full Publications Feed', 'thegem'),
		'id'            => 'full-publications-feed',
		'description'   => esc_html__('UPW for all categories', 'thegem'),
		...
		register_sidebar(array(
		'name'          => esc_html__('Bolted/Bonded Joints', 'thegem'),
		'id'            => 'bolted-feed',
		'description'   => esc_html__('UPW for Bolted/Bonded Joints category', 'thegem'),
		'before_widget' => '<div class="content">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="page-title">',
		'after_title'   => '</h1>',
			...
			register_sidebar(array(
		'name'          => esc_html__('Composite Fuselage/ATCAS', 'thegem'),
		'id'            => 'composite-feed',
		'description'   => esc_html__('UPW for Composite Fuselage/ATCAS category', 'thegem'),
		'before_widget' => '<div class="content">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="page-title">',
		'after_title'   => '</h1>',
				...
				register_sidebar(array(
		'name'          => esc_html__('Damage Tolerance', 'thegem'),
		'id'            => 'damage-feed',
		'description'   => esc_html__('UPW for Damage Tolerance category', 'thegem'),
		'before_widget' => '<div class="content">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="page-title">',
		'after_title'   => '</h1>',
					...
					register_sidebar(array(
		'name'          => esc_html__('Fracture & Fatigue', 'thegem'),
		'id'            => 'fracture-feed',
		'description'   => esc_html__('UPW for Fracture & Fatigue category', 'thegem'),
		'before_widget' => '<div class="content">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="page-title">',
		'after_title'   => '</h1>',
						...
						register_sidebar(array(
		'name'          => esc_html__('Optimization', 'thegem'),
		'id'            => 'optimization-feed',
		'description'   => esc_html__('UPW for Optimization category', 'thegem'),
		'before_widget' => '<div class="content">',
		'after_widget'  => '</div>',
		'before_title'  => '<h1 class="page-title">',
		'after_title'   => '</h1>',
...
function thegem_scripts() {
	...
	if(get_stylesheet() === get_template()) {
		...
		wp_enqueue_style('thegem-style', get_template_directory_uri().'/style.1.css', array('thegem-reset', 'thegem-grid'));
...
function modify_read_more_link() {
    return '<a class="more-link" href="' . get_permalink() . '">Abstract</a>';
}
